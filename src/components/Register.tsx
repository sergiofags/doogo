        ...
        <div className="min-h-screen bg-gray-100 flex items-center">
            <div className="container mx-auto max-w-md shadow-md hover:shadow-lg transition duration-300">
                <form className="py-12 p-10 bg-white rounded-xl" onSubmit={handleSubmit}>
                    <h2 className="mr-4 text-gray-700 font-bold inline-block mb-8 text-2xl" for="name">Register</h2>
                    <div className="mb-6">
                        <label className="mr-4 text-gray-700 font-bold inline-block mb-2" for="name">Username</label>
                    ...
                    <div className="">
                        <label className="mr-4 text-gray-700 font-bold inline-block mb-2" for="name">Confirm password</label>
                        <input type="text" className="border bg-gray-100 py-2 px-4 w-96 outline-none focus:ring-2 focus:ring-indigo-400 rounded" type="password" value={password} onChange={(e) => setPassword(e.target.value)} />
                    </div>
                    ...
                    <Link href="/login" className="text-sm text-gray-700 inline-block mt-4 hover:text-indigo-600 hover:underline hover:cursor-pointer transition duration-200 cursor-pointer">Already have an account? Log in</Link>
                </form>
            </div>
        </div>
    );
